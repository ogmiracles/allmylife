          ...
          <div class="card">
            <div class="card-body p-4">
              ...
              <div class="row">
                ...
                <div class="col-lg-7">
                  <h5 class="mb-3"><a href="#!" class="text-body"> <i class="fas fa-long-arrow-alt-left me-2">
                      </i>Continue shopping</a></h5>
                  <hr>

                  <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                      <p class="mb-2">Shopping Wishlist</p>
                    </div>
                    <div>
                      <div v-if="wishList.length > 0">
                        <button @click="clearCart()" style="border: none;">Clear Wishlist</button>
                      </div>
                    </div>
                  </div>
                  <div v-if="wishList.length === 0">
